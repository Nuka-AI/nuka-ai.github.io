...
| ![Research 4](assets/project-4-rusted.png) | **Case File 05: The Ghost in the Machine**<br>Status: `[AWAITING RESPONSIBLE DISCLOSURE]`<br>**CVSS:** `10.0 (CRITICAL)`<br>**Vector:** `AV:N/AC:L/PR:N/UI:N/S:C/C:H/I:H/A:H`<br>**Justification:** Terminal event. Full-spectrum host compromise with zero forensic footprint. |
...
* **April 28, 2026:** [Case File 01: The Abstraction Leak (RCE Bypass)](posts/2026-07-14-initial-disclosure.md) `[ACTIVE]`
